...
const PAGE_META = {
  "/dashboard": {
    ...
    sub: "Match resumes to open needs, and track them through to hire",
  },
  "/pool": { title: "Talent Pool", sub: "Every resume submitted lands here" },
  "/internal-portal": {
    title: "Internal Portal",
    sub: "Search current employees for internal mobility",
  },
  "/rejected": {
    title: "Rejected Candidates",
    sub: "Candidates who didn't move forward",
  },
  "/interview-analytics": {
    title: "Interview Analytics",
    sub: "Round-by-round performance across the pipeline",
  },
  "/qr": {
    title: "Share QR Code",
    ...
    <Box sx={{ display: "flex", minHeight: "100vh", bgcolor: colors.bg }}>
      ...
      >
        ...
        >
          <Box>
            <Typography
              sx={{ fontSize: 19, fontWeight: 800, color: colors.navy }}
            >
              {meta.title}
            </Typography>
            <Typography
          ...
          <Box sx={{ display: "flex", alignItems: "center", gap: 2.25 }}>
              ...
              <InputBase
                ...
                onKeyDown={(e) => {
                  if (e.key === "Enter" && e.target.value)
                    navigate(`/pool?q=${encodeURIComponent(e.target.value)}`);
                }}
              />
            </Box>
            <Box
            ...
            <Box sx={{ display: "flex", alignItems: "center", gap: 1.25 }}>
              ...
              <Box>
                ...
                <Typography sx={{ fontSize: 10.5, color: colors.navySoft }}>
                  Hiring Manager
                </Typography>
              </Box>
            </Box>
