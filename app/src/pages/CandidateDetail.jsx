...
export default function CandidateDetail() {
  ...
  const interviewRounds = interviews.map((iv) => ({
    ...
    <Container maxWidth="md" sx={{ py: 5 }}>
      ...
      <Paper sx={{ p: 4, mb: 3 }}>
        ...
        >
          ...
          <Stack direction="row" spacing={1} alignItems="center">
            ...
            {/* show all the interview rounds but highlight the next round to be scheduled */}
        ...
        <Grid container spacing={2}>
          ...
          <Grid item xs={12} sm={6} sx={{ display: "flex", flexDirection: "row", justifyContent: "space-between", gap: 1, flexWrap: "wrap" }}>
            <Button
            ...
            >
             ...
             <Button onClick={() => setShowSkills((prev) => !prev)}
               variant="outlined"
        ...
        {showSkills && (
          <>
            ...
            <Stack direction="row" spacing={1} flexWrap="wrap" sx={{ gap: 1, mt: 1.5 }}>
      ...
      <Paper sx={{ p: 4, mb: 3 }}>
        ...
        {candidate.status === "on-hold" && !nextRound && (
          ...
          >
            This candidate is on hold. Update their status manually, or use the
            API's manual-round option to resume.
          </Typography>
        )}
