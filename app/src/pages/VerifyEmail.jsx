...
export default function VerifyEmail() {
  ...
  useEffect(() => {
    ...
    axios.get("/auth/verify-email", { params: { token } })
      .then((res) => {
        setStatus("success");
    ...
    <Box sx={{ minHeight: "80vh", display: "flex", alignItems: "center", justifyContent: "center", px: 2 }}>
      <Container maxWidth="xs">
        <Paper sx={{ p: 4, borderRadius: 3, textAlign: "center" }}>
          ...
          {status === "success" && <CheckCircle2 size={48} color="#15803d" style={{ marginBottom: 12 }} />}
          {status === "error" && <XCircle size={48} color="#b91c1c" style={{ marginBottom: 12 }} />}
