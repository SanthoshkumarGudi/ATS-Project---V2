...
const SKILL_DICTIONARY = {
  ...
  "JavaScript": [
    "javascript", "java script", "js", "ecmascript", "es6", "es7", "es8",
    "es2015", "es2016", "es2017", "es2018", "es2019", "es2020", "es2021",
    "es2022", "vanilla js", "vanilla javascript"
  ],
  ...
  "Java": [
    "java", "core java", "java se", "java ee", "j2ee", "java 8", "java 11",
    "java 17", "java 21"
  ],
  ...
  "C": [
    ...
    "c programming", "c language", "ansi c"
  ],
  ...
  "C#": [
    "c#", "csharp", "c sharp", "c# .net", "dotnet csharp"
  ],

  "Go": [
    // "go" alone is too ambiguous; require context words
    "golang", "go language", "go programming", "go lang"
  ],
  ...
  "Swift": [
    "swift", "swift ui", "swiftui", "swift language"
  ],
  ...
  "PHP": [
    "php", "php7", "php 7", "php8", "php 8", "hypertext preprocessor"
  ],
  ...
  "R": [
    ...
    "r programming", "r language", "r studio", "rstudio", "r statistical"
  ],
  ...
  "Shell Scripting": [
    "shell scripting", "shell script", "bash scripting", "bash script",
    "bash", "zsh", "ksh", "sh scripting", "unix shell"
  ],

  "PowerShell": [
    "powershell", "power shell", "ps1", "powershell scripting"
  ],
  ...
  "Groovy": [
    "groovy", "groovy scripting", "groovy language"
  ],
  ...
  "React": [
    "react", "reactjs", "react js", "react.js", "react 18", "react hooks",
  ...
  "Angular": [
    ...
    "angular 12", "angular 14", "angular 16", "angular 17", "ng"
  ],

  "Vue.js": [
    "vue", "vuejs", "vue js", "vue.js", "vue 3", "vue 2", "nuxtjs", "nuxt.js"
  ],
  ...
  "jQuery": [
    "jquery", "jquery ui", "j query"
  ],

  "Redux": [
    "redux", "redux toolkit", "rtk", "redux-saga", "redux saga",
  ...
  "Material UI": [
    "material ui", "materialui", "mui", "material-ui", "@mui", "material design"
  ],
  ...
  "D3.js": [
    "d3", "d3.js", "d3js", "data driven documents"
  ],

  "GraphQL": [
    "graphql", "graph ql", "apollo graphql", "apollo client", "apollo server"
  ],
  ...
  "Node.js": [
    "node", "node.js", "nodejs", "node js", "node.js server"
  ],

  "Express.js": [
    "express", "expressjs", "express.js", "express js", "express framework"
  ],
  ...
  "Flask": [
    "flask", "flask api", "flask framework"
  ],
  ...
  "ASP.NET Core": [
    "asp.net core", "asp net core", "aspnet core", "asp.net", "aspnet",
    "dotnet core", ".net core", "dot net core", ".net 6", ".net 7", ".net 8"
  ],
  ...
  "Gin": [
    "gin framework", "gin golang", "gin-gonic"
  ],

  "Fiber": [
    "fiber framework", "fiber golang", "gofiber"
  ],
  ...
  "iOS Development": [
    "ios development", "ios dev", "xcode", "uikit", "swiftui", "objective-c",
    "objective c"
  ],

  "Android Development": [
    "android development", "android dev", "android studio", "android sdk",
  ...
  "PostgreSQL": [
    "postgresql", "postgres", "postgre sql", "pgsql", "pg"
  ],

  "MongoDB": [
    "mongodb", "mongo db", "mongo", "nosql mongodb"
  ],
  ...
  "Microsoft SQL Server": [
    "sql server", "mssql", "ms sql", "microsoft sql", "t-sql", "tsql",
    "transact sql"
  ],
  ...
  "Firebase": [
    "firebase", "firestore", "firebase realtime database", "firebase db"
  ],

  "Elasticsearch": [
    "elasticsearch", "elastic search", "elk stack", "elastic stack"
  ],
  ...
  "SQL": [
    "sql", "structured query language", "sql queries", "sql query",
    "advanced sql", "sql joins", "stored procedures"
  ],
  ...
  "AWS": [
    ...
    "ec2", "s3", "lambda", "aws lambda", "aws ec2", "aws s3",
    "cloudfront", "aws cloudfront", "rds", "aws rds", "ecs", "eks",
    "aws ecs", "aws eks", "sqs", "sns", "aws sqs", "aws sns",
    "api gateway", "aws api gateway", "cloudwatch", "aws cloudwatch",
    "iam", "aws iam", "vpc", "aws vpc"
  ],

  "Microsoft Azure": [
    "azure", "microsoft azure", "azure cloud", "azure devops",
    "azure functions", "azure blob", "azure app service", "azure sql",
    "azure kubernetes", "aks", "azure container"
  ],

  "Google Cloud Platform": [
    "gcp", "google cloud", "google cloud platform", "gke", "google kubernetes engine",
    "bigquery", "google bigquery", "cloud run", "google cloud run",
    "pub/sub", "google pub/sub", "app engine", "google app engine",
  ...
  "Kubernetes": [
    "kubernetes", "k8s", "kube", "kubectl", "helm", "helm charts",
    "kubernetes cluster"
  ],
  ...
  "GitLab CI/CD": [
    "gitlab ci", "gitlab ci/cd", "gitlab pipelines", "gitlab cicd"
  ],
  ...
  "Apache": [
    "apache", "apache server", "apache http", "apache web server"
  ],

  "Linux": [
    "linux", "linux server", "ubuntu", "centos", "red hat", "rhel",
    "debian", "fedora", "linux administration", "unix", "unix/linux"
  ],
  ...
  "Chef": [
    "chef", "chef automation", "chef infra"
  ],
  ...
  "Jupyter": [
    "jupyter", "jupyter notebook", "jupyter lab", "jupyterlab", "ipython"
  ],

  "Apache Spark": [
    "spark", "apache spark", "pyspark", "py spark", "spark streaming",
    "spark sql"
  ],
  ...
  "Statistics": [
    ...
    "hypothesis testing", "probability", "regression analysis",
    "time series", "time series analysis"
  ],

  "Data Analysis": [
    "data analysis", "data analytics", "data analyst", "exploratory data analysis",
    "eda", "data wrangling", "data cleaning", "data manipulation"
  ],

  "Data Engineering": [
    "data engineering", "data pipelines", "etl", "elt", "data pipeline",
    "data warehouse", "data lake", "data lakehouse"
  ],

  "A/B Testing": [
    "a/b testing", "a/b test", "ab testing", "split testing",
  ...
  "OpenAI API": [
    "openai", "openai api", "chatgpt api", "gpt-4", "gpt4", "gpt-3", "gpt3",
    "gpt api"
  ],
  ...
  "MLOps": [
    "mlops", "ml ops", "model deployment", "model serving", "mlflow",
    "kubeflow", "bentoml", "sagemaker"
  ],
  ...
  "Penetration Testing": [
    ...
    "ethical hacker", "vulnerability assessment", "vapt"
  ],

  "Network Security": [
    "network security", "firewall", "ids", "ips", "intrusion detection",
    "intrusion prevention", "vpn", "network monitoring"
  ],

  "SIEM": [
    "siem", "security information and event management", "splunk",
    "arcsight", "qradar", "sentinel"
  ],

  "Cryptography": [
    "cryptography", "encryption", "decryption", "ssl", "tls", "ssl/tls",
    "pki", "public key infrastructure", "rsa", "aes"
  ],

  "OWASP": [
    "owasp", "owasp top 10", "web security", "application security", "appsec"
  ],

  "Compliance": [
    "compliance", "gdpr", "hipaa", "pci dss", "pci-dss", "iso 27001",
    "sox", "nist"
  ],

  "Incident Response": [
    "incident response", "ir", "security incident", "threat hunting",
  ...
  "Wireshark": [
    "wireshark", "packet analysis", "network packet analysis"
  ],
  ...
  "Appium": [
    "appium", "appium testing", "mobile testing"
  ],
  ...
  "Mocha": [
    "mocha", "mocha testing", "mocha chai"
  ],

  "JUnit": [
    "junit", "junit 5", "junit testing"
  ],
  ...
  "Manual Testing": [
    "manual testing", "manual test", "test cases", "test scenarios",
    "functional testing", "regression testing", "smoke testing",
    "sanity testing", "exploratory testing", "user acceptance testing", "uat"
  ],

  "Automation Testing": [
    "automation testing", "test automation", "automated testing",
    "automation framework", "qa automation"
  ],
  ...
  "InVision": [
    "invision", "in vision", "invision prototype"
  ],
  ...
  "UX Design": [
    "ux design", "user experience design", "user experience", "ux research",
    "usability testing", "user research"
  ],

  "Wireframing": [
    "wireframing", "wireframes", "wireframe", "prototyping", "prototype"
  ],

  "Design Systems": [
    "design system", "design systems", "component library", "storybook"
  ],
  ...
  "Product Management": [
    ...
    "product roadmap", "roadmap", "product strategy"
  ],

  "Agile": [
    "agile", "agile methodology", "agile development", "scrum",
    "scrum master", "sprint planning", "sprint", "kanban", "safe agile",
    "scaled agile"
  ],

  "Product Discovery": [
    "product discovery", "user stories", "user story", "epics", "backlog",
    "backlog grooming", "backlog refinement"
  ],

  "OKRs": [
    "okr", "okrs", "objectives and key results", "kpis", "kpi",
  ...
  "SEO": [
    ...
    "technical seo", "link building", "keyword research"
  ],

  "SEM": [
    "sem", "search engine marketing", "paid search", "ppc", "google ads",
    "google adwords"
  ],

  "Social Media Marketing": [
    "social media marketing", "social media management", "smm",
    "social media", "facebook ads", "instagram ads", "linkedin ads"
  ],

  "Content Marketing": [
    "content marketing", "content strategy", "content creation",
    "blog writing", "copywriting", "email marketing"
  ],
  ...
  "Financial Analysis": [
    ...
    "fp&a", "financial reporting", "financial statements"
  ],
  ...
  "Excel": [
    ...
    "vlookup", "pivot table", "pivot tables", "excel macros", "vba"
  ],

  "SAP": [
    "sap", "sap erp", "sap fi", "sap co", "sap mm", "sap sd",
    "sap hana", "sap s/4hana"
  ],

  "QuickBooks": [
    "quickbooks", "quick books", "qbo"
  ],
  ...
  "Risk Management": [
    "risk management", "risk assessment", "risk analysis", "credit risk",
  ...
  "Recruitment": [
    ...
    "hiring", "recruiting", "talent sourcing"
  ],

  "HR Management": [
    "hr management", "human resource management", "hrm", "hris",
  ...
  "Performance Management": [
    ...
    "kra", "goal setting", "360 feedback"
  ],

  "Employee Relations": [
    "employee relations", "employee engagement", "hr policies",
    "labor law", "labour law", "industrial relations"
  ],

  "Training & Development": [
    "training and development", "learning and development", "l&d",
    "employee training", "onboarding", "coaching", "mentoring"
  ],
  ...
  "Medical Coding": [
    "medical coding", "icd-10", "cpt coding", "hcpcs", "medical billing"
  ],
  ...
  "Healthcare Analytics": [
    "healthcare analytics", "health informatics", "clinical analytics",
    "population health"
  ],
  ...
  "Account Management": [
    "account management", "account manager", "client management",
    "client relations", "customer success"
  ],

  "Sales CRM": [
    "salesforce crm", "hubspot crm", "pipedrive", "zoho"
  ],

  "Negotiation": [
    "negotiation", "deal closing", "contract negotiation", "proposal writing"
  ],
  ...
  "Project Management": [
    "project management", "pmp", "prince2", "project planning",
    "project coordination", "project delivery", "project execution"
  ],
  ...
  "Lean": [
    "lean", "lean methodology", "lean six sigma", "six sigma",
    "lean manufacturing"
  ],
  ...
  "Message Queues": [
    "rabbitmq", "rabbit mq", "sqs", "message queue", "message broker",
  ...
  "Blockchain": [
    "blockchain", "ethereum", "solidity", "web3", "web 3", "nft",
  ...
  "Embedded Systems": [
    "embedded systems", "embedded c", "embedded software", "rtos",
    "real time operating system", "firmware", "microcontroller",
    "arduino", "raspberry pi", "stm32", "esp32"
  ],

  "IoT": [
    "iot", "internet of things", "iot devices", "mqtt", "edge computing"
  ],
  ...
  "Unity": [
    "unity", "unity 3d", "unity game", "unity engine"
  ],

  "Unreal Engine": [
    "unreal engine", "unreal", "ue4", "ue5", "unreal 4", "unreal 5"
  ],
  ...
  "Waterfall": [
    "waterfall", "waterfall methodology", "sdlc"
  ],

  "DevOps": [
    "devops", "dev ops", "devsecops", "dev sec ops", "site reliability",
